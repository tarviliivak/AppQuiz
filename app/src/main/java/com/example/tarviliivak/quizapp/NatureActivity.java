    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //------------------------------------------------------------------------------------------
                if (question1_choice1.isChecked()) final_score++;
                //------------------------------------------------------------------------------------------
                ...
                LayoutInflater inflater = (LayoutInflater) NatureActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                float density = NatureActivity.this.getResources().getDisplayMetrics().density;
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (question1_choice1.isChecked() || question1_choice2.isChecked() || question1_choice3.isChecked() || question1_choice4.isChecked() || question2_choice1.isChecked() || question2_choice2.isChecked() || question2_choice3.isChecked() || question2_choice4.isChecked() || question3_choice1.isChecked() || question3_choice2.isChecked() || question3_choice3.isChecked() || question3_choice4.isChecked() || question4_choice1.isChecked() || question4_choice2.isChecked() || question4_choice3.isChecked() || question4_choice4.isChecked() || question5_choice1.isChecked() || question5_choice2.isChecked() || question5_choice3.isChecked() || question5_choice4.isChecked() || !question6_answer.getText().toString().equals("") || question7_choice1.isChecked() || question7_choice2.isChecked() || question7_choice3.isChecked() || question7_choice4.isChecked() || !question8_answer.getText().toString().equals("") || question9_choice1.isChecked() || question9_choice2.isChecked() || question9_choice3.isChecked() || question9_choice4.isChecked() || question10_choice1.isChecked() || question10_choice2.isChecked() || question10_choice3.isChecked() || question10_choice4.isChecked()) {
                    ...
                    final_score=0;
                    Toast.makeText(NatureActivity.this, "Options Reset", Toast.LENGTH_SHORT).show();
                }
            }
        });
